...
/* CURRIED VALIDATORS */
exports.inNumberArray = (allowedNumbers) => (property, value) => {
...
exports.isBetween = (min, max) => (property, value) => {
  if (typeof value === 'undefined') return
...
exports.isRequiredAllOrNone = (requiredKeys) => (body) => {
...
/* VALIDATION RUNNER */
exports.validateRequest = (body, propertyValidator, schemaValidator) => {
